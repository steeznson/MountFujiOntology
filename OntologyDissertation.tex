...
It is true that a closed-world assumption is not offered as a feature of OWL languagaes but this does not preclude the ontology engineer from simulating a closed-world assumption.
...
Fortunately, Protege offers support for plugins, and it would be relatively straightforward to add functionality to automate the steps taken in §3.2.1.\par
...
The remainder of this article will evaluate the OWL ontology artefacts themselves.
