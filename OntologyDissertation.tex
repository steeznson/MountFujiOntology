...
hasTwoMountFujis and indoorScene each concern a specific individual.\par
...
This allows us to implement a pseudo-closed-world assumption, forbidding the creation of any individual except those that comprise the \textit{Views}.
...
Many of these ABoxes would be more comfortable as TBoxes.
...
The ABox (peopleMotif(Senju Musachi Province, Senju Musachi Province)) is syntactically very similar to a TBox.
