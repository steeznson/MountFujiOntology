...
The properties of this ontology are identical to the maximal detail ontology, with the exception of containsSpecificIndividuals, as we are no longer enforcing a closed-world.
\subsection{Classes}
