...
This case poses a particular challenge for OWL as, unlike a manufacturing plant, a full description of the \textit{Views} includes the restriction that there can only ever be the specific thirty-six individuals represented in the ontology.
...
The OWL2 standard also allows the creation of Data Properties as well as Object Properties.
