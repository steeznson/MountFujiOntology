...
The reflexive characteristic denotes properties that necessarily relate individuals to themselves: in this case the class View\_of\_Mount\_Fuji can only fully represent the \textit{Views of Mount Fuji} by having an exact cardinality of 36.
Similarly, 
The next most fundamental classes are Agriculture\_Theme, Animals\_Motif, Martime\_Theme, People\_Motif, Snow\_Capped\_Mount\_Fuji and Urbanisation\_Theme.
% reasoner output
