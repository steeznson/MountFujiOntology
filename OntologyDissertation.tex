...
\begin{lstlisting}
 ...
 owl:Thing
\end{lstlisting}
The classes with the named with the pattern \_\_AND\_\_ indicate an intersection.
Similarly the naming pattern \_NOT\_\_ indicates a disjunction.
The different colour attributions for Mount Fuji are also disjoint from one another.
Maritime\_Theme is subsumed by Bodies\_of\_Water\_Motif as bodies of water are a prerequisite for maritime activity.
Likewise, horses and wildlife classes are subsumed by the Animals\_Motif.\par
...
treeForeground
\end{lstlisting}
The naming conventions for the properties are more self-explanatory.
It is worth pointing out that containsSpecificIndividuals is unusual for applying to individuals at the class level but the others are satisfied directly by individuals.
boatsForegroundOrBackground subsumes hasBoatForeground and uses the Martime\_Theme class as its domain as every individual that satisfies this property will be restricted to this class.\par
...
The reasoner had little trouble adapting to the closed-world assumption.
A disjoint union is a set comprised of individuals that are not common to each of its constituent classes.
...
Individual: A_View_of_Mount_Fuji_Across_Lake_Suwa
    ...
    Facts:  
     boatsForegroundOrBackground  A_View_of_Mount_Fuji_Across_Lake_Suwa,
...
Individual: Bay_of_Noboto
    ...
    Facts:  
     boatsForegroundOrBackground  Bay_of_Noboto,
...
Individual: Enoshima_in_Sagami_Province
    ...
    Facts:  
     boatsForegroundOrBackground  Enoshima_in_Sagami_Province,
...
Individual: Nihonbashi_bridge_in_Edo
    ...
    Facts:  
     boatsForegroundOrBackground  Nihonbashi_bridge_in_Edo,
...
Individual: Tama_River_in_Musashi_Province
    ...
    Facts:  
     boatsForegroundOrBackground  Tama_River_in_Musashi_Province,
...
Individual: Mount_Fuji_reflects_in_Lake_Kawaguchi
    ...
    Facts:  
     hasBoatForeground  Mount_Fuji_reflects_in_Lake_Kawaguchi,
     hasTwoMountFujis  Mount_Fuji_reflects_in_Lake_Kawaguchi
...
Individual: Nihonbashi_bridge_in_Edo
    ...
    Facts:  
     boatsForegroundOrBackground  Nihonbashi_bridge_in_Edo,
     hasBoatForeground  Nihonbashi_bridge_in_Edo,
     rooftopsForeground  Nihonbashi_bridge_in_Edo
