...
It had previously been established that naive reasoners, those without a firm grasp of logical rules, have to rely on some form of mental modelling to make an inference, with inclusive disjunction proving particularly challenging to mentally grasp \cite[552]{usability2014}.
...
It is true that Manchester OWL seeks to provide better legibility but it does not purport to have perfected it.
