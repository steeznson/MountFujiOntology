...
The OWL2 standard the latest version of OWL and is recommended by the World Wide Web Consortium (W3) for ontology engineering \cite[22]{introduction2011}.
...
The second accepts OWL's default settings but tries to maintain the same level of description as the first ontology.
...
While plugin availability is also important, the Protégé team are already encouraging community development through supporting plugins as a feature, their use of a permissive license and hosting the source files for the application publicly on GitHub.
