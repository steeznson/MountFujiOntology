...
Framed as two separate equivalent classes, a human reader of the ontology artefact will be able to clearly see the steps in the closed-world assumption.\par
...
As the singleton class is subsumed by the View\_of\_Mount\_Fuji it cannot contradict the parameters of its superclass.
