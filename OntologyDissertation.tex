...
The scenes accomodate a variety of seasons, motifs and themes.
...
Firstly it is restricted to an exact cardinality and the set of works contains specific individuals.
This poses a problem for OWL as an accurate modelling this world requires a closed-world assumption.\par
...
\begin{quote}
  The non-finiteness of the domain and the open-world assumption are distinguishing features of Description Logics with respect to the modelling languages developed in the study of databases (Baader, 2003, 11).
\end{quote}
...
\bibitem{}
  ...
  \textit{Expressiveness and tractibility in knowledge represesentation and reasoning},
