...
The article concludes that most issues can be solved at the software implementation-level and makes the following recommendations: encourage a wider array of Protégé plugins to facilitate unusual OWL use-cases; enhance reasoner functionality to encourage good OWL practices by providing intelligent recommendations to ontology engineers, and; standardise reasoners to encourage full implementation of the OWL standard.
...
Protégé was utilised in the production of the ontologies for the case study in this article with the default Pellet reasoner plugin.\footnote{Protégé Wiki: https://protegewiki.stanford.edu/wiki/Using\_Reasoners/ - accessed 23.03.18}
