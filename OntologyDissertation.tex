...
Protege offers support for plugins and it would be relatively straightforward to add functionality to automate the steps taken in §3.2.1.\par
...
None of the reasoners currently bundled with Protege can identify poor ontology design: while it may prove a challenge to implement, many integrated development environments (IDE) offer intelligent code completion and recommendations to keep developers on track.
...
The case study does suggest that some features may be lacking from Protege's extend toolset.
Contributors to Protege ought to consider expanding the functionality of future reasoners and creating new plugins to cover a wide range of use-cases.\par
% MOTIVATION

\section{Simple Perl Parser}
The Protege ontology creation tool saves its output to a variety of formats, including Manchester OWL2.
