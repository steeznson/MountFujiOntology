...
The goal of each of these ontologies is to uniquely capture every individual in the \textit{Views}, alongside their defining features.
...
While it may be more parsimonious to merge the classes and apply both properties to owl:Thing, in this case it is more descriptive to apply the restrictions separately to each class.
