...
Donini \cite[135]{donini2003} identifies individuals as a source of difficulty for reasoners.
...
While it may be more parsimonious to merge the classes and apply both properties to owl:Thing, in this case it is more descriptive to apply the restrictions separately; even though they are both ultimately being applied to the same class.
...
The reasoner could think that the class can only have one individual, until it becomes apparent that there is another, and then tries to accommodate this relationship by postulating that the singleton classes have merged.\par
