# MSc Dissertation on Ontology Engineering
...
`search_ontology.pl' is a small perl script for viewing the ontologies for those without access Protégé (or for quick reference to opening multiple instances of Protégé).
